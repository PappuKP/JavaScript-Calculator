...
let mathController = (() => {
  let numberArr = [],
    acc = 0,
    result = 0,
    opCount = 0; //Global variables aux
  let menus = 0,
    auxCalcMenus = 0,
    sign; // Auxs for +/- calculation
  let modu = 0,
    per = 0,
    tempAcc = 0; // Auxs for % calculation
...
let uiController = (() => {
  ...
  let displayArr = [],
    mainDisLimit = false; //Auxs for Main Display.
  let miniDisplayArr = [],
    tempPer = 0,
    miniDisLimit = false; //Aux for miniDisplay.
